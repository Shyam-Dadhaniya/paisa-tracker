...
export default function CategorySheet({ open, onClose, selected, onSelect }: Props) {
  ...
  return (
    <BaseSheet open={open} onClose={onClose} side="bottom" className="max-h-[80vh]">
      {/* Handle bar */}
        ...
        {view === 'list' ? (
          ...
          >
            ...
            <div className="overflow-y-auto flex-1 px-5 space-y-5 pb-6">
              ...
              <div>
                <label className="text-xs text-muted uppercase tracking-wider mb-2 block">Name</label>
                <input
                  value={label}
              ...
              <div>
                <label className="text-xs text-muted uppercase tracking-wider mb-3 block">Color</label>
